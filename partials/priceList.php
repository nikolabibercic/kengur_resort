<?php if(isset($_SESSION["language"]) and $_SESSION["language"]=="eng"): ?>
    ...
    <div class="pricelistHeader"><h3>Pricelist</h3></div>
...
<div class="priceListDetails"  id="kartaPica">
    ...
    <table>
        ...
        <tr>
            <td id="td1">Still water - Aqua Viva</td>
            <td id="td2">0.5</td>
            <td id="td3">250</td>
        </tr>
        <tr>
            <td id="td1">Mineral water - Knjaz Miloš</td>
            <td id="td2">0.5</td>
            <td id="td3">250</td>
        </tr>
    </table>
...
<div class="pricelistHeader"><h3>Cenovnik</h3></div>
...
<article class="pricelist">
    ...
    <div class="priceListDetails"  id="kartaPica">
        ...
        <table>
            ...
            <tr>
                <td id="td1">Voda gazirana - Knjaz Miloš</td>
                <td id="td2">0.5</td>
                <td id="td3">250</td>
            </tr>
        </table>
