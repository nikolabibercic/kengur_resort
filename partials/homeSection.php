<?php if(isset($_SESSION["language"]) and $_SESSION["language"]=="eng"): ?>
    ...
    <section class="mainSection">      
        ...
        <article class="secondarySection">
            ...
            needs for refreshment and relaxation in a luxurious environment. The rooms and suites are designed
            to provide comfort and convenience as an integral part of our guests' experience. Modernly equipped
            rooms and apartments are considered a comfortable haven away from the stress and hustle of the city.</p>    
            <div class="services">
    ...
    <section class="mainSection">      
        <img src="img/salaZaProslave1.jpg" alt="Sala za proslave" id="img1">  
        <article class="secondarySection">
            <a href="saleZaProslave.php"><h2>Venues for celebration</h2></a>
            <p>The capacity of our festivity halls is up to 250 seats and is suitable for numerous types of private and
            corporate celebrations. The ideal combination of various details in the interior follows the modern trends in organizing events. The halls are intended for various gatherings, and our employees will help you adapt the space to your particular desires.</p>    
            <div class="services">
                <i class="fa-solid fa-wifi"></i>
                <i class="fa-solid fa-martini-glass"></i>
                <i class="fa-solid fa-square-parking"></i>
...
<?php else: ?>
   ...
   <section class="mainSection">      
    ...
    <section class="mainSection">      
        <img src="img/restoran1.jpg" alt="Restoran" id="img1">  
        <article class="secondarySection">
            <a href="restoran.php"><h2>Restoran</h2></a>  
            <p>U prijatnom ambijentu restorana "Kengur" nudimo vam jela nacionalne kuhinje i bogato odabranu kartu domaćih i stranih vina kao i ostalih alkoholnih pića. Sam enterijer kompleksa predstavlja spoj tradicionalnog i modernog u kome preovlađuju palete toplih boja. Naš restoran vredi posetiti zbog vrhunskog menija, svežh namirnica i profesionalno obučenih kuvara za pripremu različitih jela. </p>    
            <div class="services">      
                <i class="fa-solid fa-champagne-glasses"></i>
                <i class="fa-solid fa-utensils"></i>
                <i class="fa-solid fa-wifi"></i>
